...
public class SubscribeService extends BaseAPIService {
    ...
    public void subscribe(String title, String siteUrl, String category, Response.ErrorListener errorListener) {
    ...
    public void unsubscribe(int siteId, Response.ErrorListener errorListener) {
